...
# /build/linux-hwe-9KJ07q/linux-hwe-4.18.0/kernel/bounds.c -mno-sse
...
# -mindirect-branch-register -mfentry -mrecord-mcount -march=x86-64
...
1:	call	__fentry__
	...
	pushq	%rbp	#
	movq	%rsp, %rbp	#,
# /build/linux-hwe-9KJ07q/linux-hwe-4.18.0/kernel/bounds.c:19: 	DEFINE(NR_PAGEFLAGS, __NR_PAGEFLAGS);
#APP
# 19 "/build/linux-hwe-9KJ07q/linux-hwe-4.18.0/kernel/bounds.c" 1
	
.ascii "->NR_PAGEFLAGS $25 __NR_PAGEFLAGS"	#
# 0 "" 2
# /build/linux-hwe-9KJ07q/linux-hwe-4.18.0/kernel/bounds.c:20: 	DEFINE(MAX_NR_ZONES, __MAX_NR_ZONES);
# 20 "/build/linux-hwe-9KJ07q/linux-hwe-4.18.0/kernel/bounds.c" 1
	
.ascii "->MAX_NR_ZONES $5 __MAX_NR_ZONES"	#
# 0 "" 2
# /build/linux-hwe-9KJ07q/linux-hwe-4.18.0/kernel/bounds.c:22: 	DEFINE(NR_CPUS_BITS, ilog2(CONFIG_NR_CPUS));
# 22 "/build/linux-hwe-9KJ07q/linux-hwe-4.18.0/kernel/bounds.c" 1
	
.ascii "->NR_CPUS_BITS $13 ilog2(CONFIG_NR_CPUS)"	#
# 0 "" 2
# /build/linux-hwe-9KJ07q/linux-hwe-4.18.0/kernel/bounds.c:24: 	DEFINE(SPINLOCK_SIZE, sizeof(spinlock_t));
# 24 "/build/linux-hwe-9KJ07q/linux-hwe-4.18.0/kernel/bounds.c" 1
	
.ascii "->SPINLOCK_SIZE $4 sizeof(spinlock_t)"	#
# 0 "" 2
# /build/linux-hwe-9KJ07q/linux-hwe-4.18.0/kernel/bounds.c:28: }
#NO_APP
	xorl	%eax, %eax	#
	popq	%rbp	#
	ret
